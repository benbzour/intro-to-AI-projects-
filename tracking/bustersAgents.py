...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for ghost in livingGhostPositionDistributions:
            ...
            uncapturedLikelyPos.append(mostLikely)
            # print(uncapturedLikelyPos)
        # minimize maze distance
        minDist = float("inf")
        minAct = None
        for pos in uncapturedLikelyPos:
            for act in legal:
                successorPosition = Actions.getSuccessor(pacmanPosition, act)
                successorDist = self.distancer.getDistance(pos,successorPosition)
                if successorDist < minDist:
                    minDist = successorDist
                    minAct = act
        return minAct
